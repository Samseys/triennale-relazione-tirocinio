...
Spring si basa sul concetto di \textit{Inversion of Control} (IoC), dove gli oggetti invece di creare le loro dipendenze direttamente le ricevono da fonti esterne.
...
\\\\
Spring con SpringBoot fornisce quindi un pacchetto completo e semplice da usare per creare applicazioni complesse in tempi di sviluppo ridotti.
\subsection{Angular}
Placeholder
